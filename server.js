...
app.use((req, res, next) => {
  ...
  res.setHeader("Access-Control-Allow-Headers", "Access-Control-Allow-Headers, section_id, Origin, Authorization, Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers");
  next();
})
